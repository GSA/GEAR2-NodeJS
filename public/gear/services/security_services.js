...
angular.module('dashboard')
  .factory('FISMASrc', ['$resource', 'WcfConfig', function($resource,
    WcfConfig) {
    return $resource('/api/v0/fisma/:id');
  }])
  .factory('FISMAexpSrc', ['$resource', 'WcfConfig', function($resource,
    WcfConfig) {
    return $resource('/api/v0/fismaexp');
  }])
  .factory('FISMAexp1Src', ['$resource', 'WcfConfig', function($resource,
    WcfConfig) {
    return $resource('/api/v0/fismaexp/thisyear');
  }])
  .factory('FISMAexp2Src', ['$resource', 'WcfConfig', function($resource,
    WcfConfig) {
    return $resource('/api/v0/fismaexp/nextyear');
  }])
  .factory('FISMAApplicationsSrc', ['$resource', 'WcfConfig', function(
    $resource, WcfConfig) {
    return $resource('/api/v0/fisma/:id/applications');
  }])
  .factory('FISMAPOCsSrc', ['$resource', 'WcfConfig', function($resource,
    WcfConfig) {
    return $resource('/api/v0/fisma/:id/pocs');
  }])
  .factory('FISMAAppsSrc', ['$resource', 'WcfConfig', function($resource,
    WcfConfig) {
    return $resource('/api/v0/fisma/:id/applications');
  }])
...
angular.module('dashboard').factory('FISMA', ['$resource', 'WcfConfig',
...
angular.module('dashboard').factory('FISMAPOC', ['$resource', 'WcfConfig',
  function($resource, WcfConfig) {
    // Use the '$resource' service to return an FISMA System '$resource' object
    return $resource(WcfConfig.urlRoot + 'EAOpen.svc/fisma_systems/', {
      fismaId: '@_id'
...
angular.module('dashboard').factory('RISSO', ['$resource', 'WcfConfig',
  function($resource, WcfConfig) {
    // Use the '$resource' service to return an FISMA System '$resource' object
...
angular.module('dashboard').factory('FISMAexp', ['$resource', 'WcfConfig',
  function($resource, WcfConfig) {
    // Use the '$resource' service to return an FISMA System '$resource' object
    return $resource(WcfConfig.urlRoot + 'EAOpen.svc/fisma_systems/', {
      fismaId: '@_id'
...
angular.module('dashboard').factory('FISMAexp1', ['$resource', 'WcfConfig',
  function($resource, WcfConfig) {
    // Use the '$resource' service to return an FISMA System '$resource' object
    return $resource(WcfConfig.urlRoot + 'EAOpen.svc/fisma_systems/', {
      fismaId: '@_id'
...
angular.module('dashboard').factory('FISMAexp2', ['$resource', 'WcfConfig',
  function($resource, WcfConfig) {
    // Use the '$resource' service to return an FISMA System '$resource' object
    return $resource(WcfConfig.urlRoot + 'EAOpen.svc/fisma_systems/', {
      fismaId: '@_id'
