...
angular.module('dashboard')
  .factory('OrganizationsSrc', ['$resource', 'WcfConfig', function($resource,
    WcfConfig) {
    return $resource('/api/v0/organizations/:id');
  }])
  // replaces 'OrgAppMap'
  .factory('OrgAppsSrc', ['$resource', 'WcfConfig', function($resource,
    WcfConfig) {
    return $resource('/api/v0/organizations/:id/applications');
  }])
  // TODO:// Orphan
  // tbr: 'GetOrgSysMap'
  .factory('OrgSysSrc', ['$resource', 'WcfConfig', function($resource,
    WcfConfig) {
    return $resource('/api/v0/organizations/:id/systems');
  }])
  // replaces 'BusFunction' aka Capabilities
  .factory('CapabilitiesSrc', ['$resource', 'WcfConfig', function($resource,
    WcfConfig) {
  ...
  // new CapAppCountsSrc
  .factory('CapAppCountsSrc', ['$resource', 'WcfConfig', function($resource,
    WcfConfig) {
    return $resource('/api/v0/capabilities/app-counts');
  }])
  // new 'OrgInterfaces' (see application_services InterfacesSrc)
  .factory('OrgInterfacesSrc', ['$resource', 'WcfConfig', function($resource,
    WcfConfig) {
...
angular.module('dashboard').factory('Organization', ['$resource', 'WcfConfig',
  function($resource, WcfConfig) {
    ...
    return $resource(WcfConfig.urlRoot +
      'EAOpen.svc/organizations:organizationId', {
        organizationId: '@_id'
      });
  }
]);
// Create the 'Function' service
angular.module('dashboard').factory('BusFunction', ['$resource', 'WcfConfig',
  function($resource, WcfConfig) {
    // Use the '$resource' service to return an Organization '$resource' object
...
angular.module('dashboard').factory('OrgAppMap', ['$resource', 'WcfConfig',
  function($resource, WcfConfig) {
...
angular.module('dashboard').factory('OrgSysMap', ['$resource', 'WcfConfig',
  function($resource, WcfConfig) {
...
angular.module('dashboard').factory('OrgGoalMap', ['$resource', 'WcfConfig',
  function($resource, WcfConfig) {
