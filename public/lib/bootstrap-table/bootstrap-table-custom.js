 ...
 * 2. add proper 'dropdown' class to Bootstrap dropdown so events will work on
...
!function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            ...
            // questions from MLD...
            // 1. So what this code is saying is that If the search component is
            // initialized *with* text, delay it anyway??? Is there any other
            // reason/case this.options.searchText would not be blank and need
            // to be delayed?
            // 2. Why trigger the keyup??? Why is onSearch  designed to be
            // coupled to an event? You're in the same instance, right? There should
            // not be anything on that event object you can't get more efficiently
            // within this plugin's scope.
            // 3. This looks like it was copy-pasted from above without much
            // consideration. I'm leaving code commented in case I misunderstand
            // something.
            // New: If we're not clearing searchText after it's used, then the
            // search is run twice. Adding code to clear that.
